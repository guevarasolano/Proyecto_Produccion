...
namespace Entidades{
    ...
    public class Proceso_Llenado_BP_BJC_SAP{
        ...
        public Proceso_Llenado_BP_BJC_SAP(int Id_Proceso_Llenado, int Id_Proceso_BP_BJC,
        ...
        public Proceso_Llenado_BP_BJC_SAP() { }
