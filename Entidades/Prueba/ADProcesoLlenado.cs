...
namespace AccesoDatos{
    ...
    public class ADProcesoLlenado{
        ...
        public void insertarProcesoLlenado(Proceso_Llenado proceso_Llenado){
            ...
            cmd.Parameters.Add(new SqlParameter("@FK_Id_Articulo_SAP", proceso_Llenado.Id_Articulo_SAP));
            cmd.Parameters.Add(new SqlParameter("@FK_Id_Calidad_SAP", proceso_Llenado.Id_Calidad_SAP));
            ...
            cmd.Parameters.Add(new SqlParameter("@FK_Id_Articulo_Bolsa_SAP", proceso_Llenado.Id_Articulo_Bolsa_SAP));
        ...
        public List<Entidades.Proceso_Llenado> buscarProcesoLlenado(int Id_Proceso_Llenado){
            ...
            List<Entidades.Proceso_Llenado> lista = new List<Entidades.Proceso_Llenado>();
            ...
            while (dr.Read()){
                ...
                procesoLlenado.Id_Articulo_SAP = Convert.ToInt32(dr["FK_Id_Articulo_SAP"].ToString());
                procesoLlenado.Id_Calidad_SAP = Convert.ToInt32(dr["FK_Id_Calidad_SAP"].ToString());
                ...
                procesoLlenado.Id_Articulo_Bolsa_SAP = Convert.ToInt32(dr["FK_Id_Articulo_Bolsa_SAP"].ToString());
        ...
        public List<Entidades.Proceso_Llenado> listar(){
